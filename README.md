...
**DOWNLOAD HERE:** https://raw.githubusercontent.com/ShawnDEvans/smbmap/master/smbmap.py
...
Run Powershell Script on Victim SMB Host (you'll have to change the IP address in the code to your own IP, ie host to send shell to)
```
